...
// NFEnerComEnvio movido para NFEnerComEnvio.php (PSR-4).
...
// ArqEnerComRetorno movido para ArqEnerComRetorno.php (PSR-4).
// NFEnerComRetorno movido para NFEnerComRetorno.php (PSR-4).